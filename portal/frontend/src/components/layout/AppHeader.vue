...
// 1. Instancia del router para redirecciones manuales
const router = useRouter()

const { isAuthenticated, user, logout, loginWithGoogle } = useAuth()

// 2. Función logout con redirección al inicio
        ...
        <div class="flex items-center gap-4">
          ...
          <div v-else class="flex items-center gap-3">
            ...
            <div class="relative group">
              ...
              <!-- Dropdown (Se muestra al hacer hover gracias a group-hover:block) -->
              <div class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 hidden group-hover:block z-50 border border-gray-200 dark:border-gray-700">
                ...
                <!-- 3. CAMBIO PRINCIPAL: RouterLink con tus estilos originales -->
                <RouterLink
                    to="/perfil"
