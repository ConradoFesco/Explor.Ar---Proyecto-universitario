...
def block_user(user_id):
    ...
    try:
        ...
        result = usuario_service.block_user(user_id, admin_user_id)
        return jsonify(result), 200
...
def unblock_user(user_id):
    ...
    try:
        ...
        result = usuario_service.unblock_user(user_id, admin_user_id)
        return jsonify(result), 200
    except (ValidationError, NotFoundError) as e:
        return jsonify({"error": str(e)}), 400
    except DatabaseError as e:
...
def get_user_roles(user_id):
    ...
    try:
        result = usuario_service.get_user_roles(user_id)
...
def get_available_roles():
    ...
    try:
        result = usuario_service.get_available_roles()
        return jsonify({'roles': result}), 200
    except Exception as e:
        return jsonify({'error': str(e)}), 500
...
def assign_role_to_user(user_id, role_id):
    ...
    try:
        ...
        result = usuario_service.assign_role_to_user(user_id, role_id, admin_user_id)
        return jsonify(result), 200
    except (ValidationError, NotFoundError) as e:
        return jsonify({"error": str(e)}), 400
    except DatabaseError as e:
...
def revoke_role_from_user(user_id, role_id):
    ...
    try:
        ...
        result = usuario_service.revoke_role_from_user(user_id, role_id, admin_user_id)
        return jsonify(result), 200
    except (ValidationError, NotFoundError) as e:
        return jsonify({"error": str(e)}), 400
    except DatabaseError as e:
